 ...
 *   type: "sandbox"|"http"|"extension", // Server type
 *   code: string|null,       // JavaScript code (for sandbox servers)
 *   url: string|null,        // Server URL (for http servers)
 *   extensionId: string|null, // Extension ID (for extension servers)
...
export const HarborServerStore = {
   ...
   * @param {string} config.type - Server type ("sandbox", "http", or "extension")
   * @param {string} [config.code] - JavaScript code (for sandbox servers)
   * @param {string} [config.url] - Server URL (for http servers)
   * @param {string} [config.extensionId] - Extension ID (for extension servers)
  ...
  saveServer(config) {
    ...
    if (config.type === "extension" && !config.extensionId) {
      throw new Error("Extension servers require an extensionId");
    }
