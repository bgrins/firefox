...
**Capability System:**
- **CapabilityGate** - Permission checking for all capability requests
- **CapabilityBridge** - Exposes browser/filesystem/network APIs to sandboxed servers
- **CapabilityProfileStore** - Stores and manages permission profiles per server

**Development UI:**
- **Harbor** - Development interface for testing MCP servers (chrome://browser/content/aiwindow/harbor.html)

**Integration:**
- **Chat.sys.mjs** - MCP tools integrated with aiwindow chat

See [MCP_ARCHITECTURE.md](../../MCP_ARCHITECTURE.md) for architecture overview.
