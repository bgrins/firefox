...
!(function (e, t) {
  ...
  function ee(e, t) {
    ...
    let s = 0;
    if (
      (n[0].trim() || n.shift(), !!n.length && !n.at(-1)?.trim() && n.pop(), t)
    ) {
      if (n.length > t) {
        n.splice(t);
      } else {
        ...
        for (let e = 0; e < r.items.length; e++) {
          if (
            ...
            const t = r.items[e].tokens.filter(e => "space" === e.type),
              n =
                !!t.length && t.some(e => this.rules.other.anyLine.test(e.raw));
            r.loose = n;
          }
        }
        if (r.loose) {
  ...
  class re {
    ...
    inlineTokens(e, t = []) {
      ...
      for (
        ;
        null != (s = this.tokenizer.rules.inline.anyPunctuation.exec(n));
