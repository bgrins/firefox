...
const PREF_WIDGETS_GAME_ENABLED = "widgets.sokobanGame.enabled";
...
const PREF_GAME_SIZE = "widgets.sokobanGame.size";
...
const PREF_WIDGETS_SYSTEM_GAME_ENABLED =
...
;// CONCATENATED MODULE: ./content-src/components/Widgets/SokobanGame/SokobanGame.jsx
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this file,
 * You can obtain one at http://mozilla.org/MPL/2.0/. */
...
function checkWin(state) {
  return state.boxes.every(box => state.goals.some(goal => goal.x === box.x && goal.y === box.y));
}
function movePlayer(engine, direction) {
  ...
  if (boxIdx !== -1) {
    ...
    if (!isInBounds(newBoxPos, state) || isWall(newBoxPos, state) || findBoxAt(newBoxPos, state) !== -1) {
      return {
        valid: false,
        engine
      };
...
function useKitImages() {
  const [images, setImages] = (0,external_React_namespaceObject.useState)({
    happy: null,
    concerned: null
  });
  (0,external_React_namespaceObject.useEffect)(() => {
...
function renderGame(canvas, gameState, kitImages, isWin) {
  ...
  gameState.boxes.forEach(box => {
    ...
    const onGoal = gameState.goals.some(g => g.x === box.x && g.y === box.y);
  ...
  // Player (Kit face)
  const playerOnGoal = gameState.goals.some(g => g.x === gameState.player.x && g.y === gameState.player.y);
  ...
  if (isWin) {
    ...
    if (kitImages?.happy) {
      ctx.drawImage(kitImages.happy, (width - kitSize) / 2, height / 2 - kitSize * 0.65, kitSize, kitSize * 0.8);
    }
...
function SokobanGame({
  ...
  const [levelIndex, setLevelIndex] = (0,external_React_namespaceObject.useState)(0);
  const [engine, setEngine] = (0,external_React_namespaceObject.useState)(() => createEngine(MICROBAN_LEVELS[0]));
  const [isWin, setIsWin] = (0,external_React_namespaceObject.useState)(false);
  const canvasRef = (0,external_React_namespaceObject.useRef)(null);
  const containerRef = (0,external_React_namespaceObject.useRef)(null);
  const kitImages = useKitImages();
  const draw = (0,external_React_namespaceObject.useCallback)(() => {
  ...
  const loadLevel = (0,external_React_namespaceObject.useCallback)(idx => {
  ...
  const handleMove = (0,external_React_namespaceObject.useCallback)(direction => {
    if (isWin) {
      return;
    }
  ...
  const handleUndo = (0,external_React_namespaceObject.useCallback)(() => {
    if (!isWin) {
      setEngine(e => undoMove(e));
    }
  }, [isWin]);
  const handleRedo = (0,external_React_namespaceObject.useCallback)(() => {
    if (!isWin) {
  ...
  const handleNextLevel = (0,external_React_namespaceObject.useCallback)(() => {
    if (levelIndex < MICROBAN_LEVELS.length - 1) {
      loadLevel(levelIndex + 1);
    }
  }, [levelIndex, loadLevel]);
  const handlePrevLevel = (0,external_React_namespaceObject.useCallback)(() => {
    if (levelIndex > 0) {
      loadLevel(levelIndex - 1);
    }
  }, [levelIndex, loadLevel]);
  (0,external_React_namespaceObject.useEffect)(() => {
    const handleKey = e => {
      ...
      if (active && active !== document.body && widgetEl && !widgetEl.contains(active)) {
        return;
      }
      let handled = true;
      switch (e.key) {
  ...
  }, [handleMove, handleUndo, handleRedo, handleReset, handleNextLevel, isWin]);
  return /*#__PURE__*/external_React_default().createElement("article", {
    ref: containerRef,
    className: `sokoban-game widget ${novaEnabled ? `col-4 ${widgetSize}-widget` : ""} ${isMaximized ? "is-maximized" : ""}`,
    tabIndex: "-1"
  }, /*#__PURE__*/external_React_default().createElement("div", {
    className: "sokoban-header"
  }, /*#__PURE__*/external_React_default().createElement("span", {
    className: "sokoban-title"
  }, "Kit's Sokoban"), /*#__PURE__*/external_React_default().createElement("span", {
    className: "sokoban-level-info"
  }, /*#__PURE__*/external_React_default().createElement("button", {
    ...
    className: "sokoban-level-num"
  }, levelIndex + 1, "/", MICROBAN_LEVELS.length), /*#__PURE__*/external_React_default().createElement("button", {
    className: "sokoban-btn",
    onClick: handleNextLevel,
    disabled: levelIndex === MICROBAN_LEVELS.length - 1,
    title: "Next level"
  }, ">")), /*#__PURE__*/external_React_default().createElement("span", {
    className: "sokoban-stats"
  }, "Moves: ", engine.state.moves, " | Pushes: ", engine.state.pushes)), /*#__PURE__*/external_React_default().createElement("div", {
    className: "sokoban-canvas-container"
  }, /*#__PURE__*/external_React_default().createElement("canvas", {
    ref: canvasRef
  })), /*#__PURE__*/external_React_default().createElement("div", {
    className: "sokoban-controls"
  }, /*#__PURE__*/external_React_default().createElement("button", {
    className: "sokoban-btn",
    onClick: handleUndo,
    disabled: engine.history.length === 0 || isWin,
    title: "Undo (U / Ctrl+Z)"
  }, "Undo"), /*#__PURE__*/external_React_default().createElement("button", {
    className: "sokoban-btn",
    onClick: handleRedo,
    disabled: engine.redoStack.length === 0 || isWin,
    title: "Redo (Ctrl+Shift+Z)"
  }, "Redo"), /*#__PURE__*/external_React_default().createElement("button", {
    className: "sokoban-btn",
    onClick: handleReset,
    title: "Reset (R)"
  }, "Reset"), isWin && /*#__PURE__*/external_React_default().createElement("button", {
    className: "sokoban-btn sokoban-btn-next",
    onClick: handleNextLevel
  }, "Next Level")));
}
...
function WidgetsManagementPanel({
  ...
  })), mayHaveSokobanGame && /*#__PURE__*/external_React_default().createElement("div", {
    id: "sokoban-widget-section",
    className: "section"
  }, /*#__PURE__*/external_React_default().createElement("moz-toggle", {
    id: "sokoban-toggle",
...
class _CustomizeMenu extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    novaEnabled ? /*#__PURE__*/external_React_default().createElement("moz-button", {
      ...
      mayHaveSokobanGame: this.props.mayHaveSokobanGame,
      dispatch: this.props.dispatch,
...
class BaseContent extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    const mayHaveSokobanGame = prefs["widgets.system.sokobanGame.enabled"] || prefs.trainhopConfig?.widgets?.sokobanGameEnabled;
    ...
    if (novaEnabled) {
      ...
      const hasContentWidgets = mayHaveListsWidget && enabledWidgets.listsEnabled || mayHaveTimerWidget && enabledWidgets.timerEnabled || mayHaveSokobanGame && enabledWidgets.sokobanGameEnabled || mayHaveWeatherWidget && enabledWidgets.weatherEnabled && !weatherGoesToSidebar;
