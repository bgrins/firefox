...
def test_get_wpt_path_and_metadata():
    """Test get_wpt_path_and_metadata function"""

    # Test regular WPT paths
    path, meta = get_wpt_path_and_metadata("/css/test.html")
    assert path == "testing/web-platform/tests/css/test.html"
    assert meta == "testing/web-platform/meta/css/test.html"

    # Test mozilla-specific paths
    path, meta = get_wpt_path_and_metadata("/_mozilla/test.html")
    assert path == "testing/web-platform/mozilla/tests/test.html"
    assert meta == "testing/web-platform/mozilla/meta/test.html"

    # Test infrastructure paths
    path, meta = get_wpt_path_and_metadata("/infrastructure/test.html")
    assert path == "testing/web-platform/tests/infrastructure/test.html"
    assert meta == "testing/web-platform/meta/infrastructure/test.html"
